                ...
                <form action="{{ route('admin.projects.store') }}" method="POST">
                    ...
                    <div>
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" class="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline bg-gray-700 text-gray-200" required>
                        </div>
                        <div class="mb-4">
                            <label for="description" class="block text-gray-400 text-sm font-bold mb-2">Description:</label>
                            <textarea name="description" id="description" rows="4" class="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline bg-gray-700 text-gray-200" required></textarea>
                        </div>
                        <div class="mb-4">
                            <label for="url" class="block text-gray-400 text-sm font-bold mb-2">URL:</label>
                            <input type="text" name="url" id="url" class="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline bg-gray-700 text-gray-200">
                        </div>
                        <div class="mb-4">
