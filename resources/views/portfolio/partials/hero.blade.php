    ...
    <div class="text-left -mt-24">
        ...
        <div class="flex justify-between">
            <p class="text-xl font-medium flex-none">
                ...
                <span class="text-gray-400">Making stuff with <span class="text-gray-200" id="languages"></span> and always learning.</span>
            </p>
        </div>
        <div class="flex flex-row gap-5 mt-5">
            <a href="https://github.com/BoyK07" target="_blank"
            ...
            <a href="https://www.linkedin.com/in/boy-krijnen/" target="_blank"
                class="w-10 h-10 bg-[#13152b] rounded-full flex items-center justify-center">
